...
async function loadData() {
  ...
  function createDataSession1() {
    ...
    for (let i = 0; i < sessaoEspecial.length; i++) {
      ...
      <div class="postInfo"><h1 id="pt">${sessaoEspecial[i].tituloPt}</h1>
        <h1 id="en">${sessaoEspecial[i].tituloEng}</h1><h3>${sessaoEspecial[i].localDuracao}</h3>
        <p id="pt">${sessaoEspecial[i].sinopsePt}</p>
        <p id="en">${sessaoEspecial[i].sinopseEng}</p>
  ...
  function createDataSession2() {
    ...
    for (let i = 0; i < sessaoVivencias.length; i++) {
      ...
      postBox.innerHTML = `
      <div class="postImg filmeImg" style="background-image: url('${src}${sessaoVivencias[i].img}')"></div><div class="postInfo"><h1 id="pt">${sessaoVivencias[i].tituloPt}</h1>
      <h1 id="en">${sessaoVivencias[i].tituloEng}</h1><h3>${sessaoVivencias[i].localDuracao}</h3><p id="pt">${sessaoVivencias[i].sinopsePt}</p><p id="en">${sessaoVivencias[i].sinopseEng}</p>
      <div id="pt" class="btn-filmes"><div class="info"><button type="button" class="collapsible"> MAIS INFORMAÇÕES <i class="fas fa-plus"></i></button>
      ...
      <div id="en" class="btn-filmes"><div class="info"><button type="button" class="collapsible"> ADDITIONAL INFORMATION <i class="fas fa-plus"></i></button>
  ...
  function createDataSession3() {
    ...
    for (let i = 0; i < sessaoAfetos.length; i++) {
      ...
      postBox.className = 'postBox hidden';
      postBox.innerHTML = `
      <div class="postImg filmeImg" style="background-image: url('${src}${sessaoAfetos[i].img}')"></div><div class="postInfo"><h1 id="pt">${sessaoAfetos[i].tituloPt}</h1>
      <h1 id="en">${sessaoAfetos[i].tituloEng}</h1><h3>${sessaoAfetos[i].localDuracao}</h3><p id="pt">${sessaoAfetos[i].sinopsePt}</p><p id="en">${sessaoAfetos[i].sinopseEng}</p>
      <div id="pt" class="btn-filmes"><div class="info"><button type="button" class="collapsible"> MAIS INFORMAÇÕES <i class="fas fa-plus"></i></button>
  ...
  function createDataSession4() {
    ...
    for (let i = 0; i < sessaoGritos.length; i++) {
      ...
      postBox.className = 'postBox hidden';
      postBox.innerHTML = `
      <div class="postImg filmeImg" style="background-image: url('${src}${sessaoGritos[i].img}')"></div><div class="postInfo"><h1 id="pt">${sessaoGritos[i].tituloPt}</h1>
      <h1 id="en">${sessaoGritos[i].tituloEng}</h1><h3>${sessaoGritos[i].localDuracao}</h3><p id="pt">${sessaoGritos[i].sinopsePt}</p><p id="en">${sessaoGritos[i].sinopseEng}</p>
      <div id="pt" class="btn-filmes"><div class="info"><button type="button" class="collapsible"> MAIS INFORMAÇÕES <i class="fas fa-plus"></i></button>
