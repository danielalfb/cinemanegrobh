...
var boxContent = [
  {
    ...
    fichaTecnica:
      '<li>direção diretor C.J. “Fiery” Obassi </li><li>roteiro script C.J. “Fiery” Obassi </li><li>fotografia cinematography Kagho Crowther Idhebor</li><li>arte e figurino art and costume design The Fiery One, Tunji Afolayan, Obijie “Byge” Oru </li><li>som sound Sunday Adesugba, Michael “Truth” Ogunlade</li><li>elenco principal main cast Keira Hewatch, Tunde Aladese, Ogee Nelson</li><li>empresa produtora production company Fiery Film, Igodo Films, Matanya Films</li><li>contato contact www.afieryfilm.com</li><li>Classificação Indicativa Livre</li>',
    sinopsePt:
...
function createData() {
  for (i = 0; i < boxContent.length; i++) {
    ...
    <p>${boxContent[i].sinopsePt}</p><p>${boxContent[i].sinopseEng}</p>
