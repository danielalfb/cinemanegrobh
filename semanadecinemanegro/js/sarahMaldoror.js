...
var boxContent = [
  {
    tituloPt:
      "ET LES CHIENS SE TAISAIENT, D'AIMÉ CÉSAIRE | AND THE DOGS WERE QUIET, BY AIMÉ CÉSAIRE\r\n",
    tituloEng: 'E OS CACHORROS CALAVAM-SE, DE AIMÉ CÉSAIRE',
    localDuracao: 'FRANÇA, 1978, 13’',
    fichaTecnica:
      '<li>direção director Sarah Maldoror </li><li>fotografia cinematography Daniel Cavillon, Maurice Perimont, Vincent Blanchet </li><li>montagem editing Simoen Jousse, Bernard Favre </li><li>som sound Henri Roux </li><li>contato contact annouchka.deandrade@gmail.com</li><li>Classificação Indicativa Livre</li>',
    sinopsePt:
