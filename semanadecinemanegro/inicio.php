      ...
      <div class="container-inicio center">
        <img class="inicio" src="img/inicio.png" alt="Foto em família ilustrada"/>
            <div class="paragrafo-inicio">
                <h3 id="pt">Sobre a semana</h3>
                <h3 id="en">About the Week</h3>
              <p id="pt">
              ...
              <p id="pt">A primeira edição da Semana de Cinema Negro de Belo Horizonte propõe um olhar de resgate às nossas memórias. 
